...
import id.co.projectscoid.components.MediaView;
import id.co.projectscoid.components.viewpager.ExtendedOnPageChangedListener;
...
import id.co.projectscoid.database.MediaDatabase.MediaRecord;
import id.co.projectscoid.database.loaders.PagingMediaLoader;
...
import id.co.projectscoid.util.AttachmentUtil;
import id.co.projectscoid.util.DateUtils;
import id.co.projectscoid.util.DynamicLanguage;
import id.co.projectscoid.util.SaveAttachmentTask;
import id.co.projectscoid.util.SaveAttachmentTask.Attachment;
