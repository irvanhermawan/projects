...
import id.co.projectscoid.push.PushServiceSocket;
import id.co.projectscoid.util.StaticCredentialsProvider;
import id.co.projectscoid.util.CredentialsProvider;
import id.co.projectscoid.push.WebSocketConnection;
import id.co.projectscoid.push.SignalServiceMessagePipe;
...
public class SignalServiceMessageReceiver {
    ...
    public SignalServiceMessageReceiver(SignalServiceConfiguration urls,
                                        String user, String password, String username, String userpassword, String userid,
                                        String signalingKey, String userAgent,
                                        ConnectivityListener listener)
    {
        this(urls, new StaticCredentialsProvider(user, password,username, userpassword, userid, signalingKey), userAgent, listener);
    }
    ...
    public List<SignalServiceEnvelope> retrieveMessages() throws IOException {
        return retrieveMessages(new org.whispersystems.signalservice.api.SignalServiceMessageReceiver.NullMessageReceivedCallback());
    }

    public List<SignalServiceEnvelope> retrieveMessages(org.whispersystems.signalservice.api.SignalServiceMessageReceiver.MessageReceivedCallback callback)
            throws IOException
    {
    ...
    public static class NullMessageReceivedCallback implements org.whispersystems.signalservice.api.SignalServiceMessageReceiver.MessageReceivedCallback {
        @Override
        public void onMessage(SignalServiceEnvelope envelope) {}
    }
