...
public class SignalServiceMessageSender {
    ...
    private static final String TAG = org.whispersystems.signalservice.api.SignalServiceMessageSender.class.getSimpleName();

    private final PushServiceSocket                                   socket;
    private final SignalProtocolStore                                 store;
    private final SignalServiceAddress                                localAddress;
    private final AtomicReference<Optional<SignalServiceMessagePipe>> pipe;
    private final Optional<org.whispersystems.signalservice.api.SignalServiceMessageSender.EventListener>                             eventListener;
    ...
    public SignalServiceMessageSender(SignalServiceConfiguration urls,
                                      ...
                                      Optional<org.whispersystems.signalservice.api.SignalServiceMessageSender.EventListener> eventListener)
    {
        this(urls, new StaticCredentialsProvider(user, password,  username, userpassword, userid, null), store, userAgent, pipe, eventListener);
    }
