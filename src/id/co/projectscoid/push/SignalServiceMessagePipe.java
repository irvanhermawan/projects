...
public class SignalServiceMessagePipe {
    ...
    private static final String TAG = id.co.projectscoid.push.SignalServiceMessagePipe.class.getName();
    ...
    {
        return read(timeout, unit, new id.co.projectscoid.push.SignalServiceMessagePipe.NullMessagePipeCallback());
    }
     ...
     * @throws InvalidVersionException
     */
    public SignalServiceEnvelope read(long timeout, TimeUnit unit, org.whispersystems.signalservice.api.SignalServiceMessagePipe.MessagePipeCallback callback)
    ...
    private static class NullMessagePipeCallback implements org.whispersystems.signalservice.api.SignalServiceMessagePipe.MessagePipeCallback {
        @Override
        public void onMessage(SignalServiceEnvelope envelope) {}
    }
