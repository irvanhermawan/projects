...
public class WebSocketConnection extends WebSocketListener {
    ...
    private static final String TAG                       = id.co.projectscoid.push.WebSocketConnection.class.getSimpleName();
    ...
    private id.co.projectscoid.push.WebSocketConnection.KeepAliveSender keepAliveSender;
    ...
    public synchronized void onOpen(WebSocket webSocket, Response response) {
        if (client != null && keepAliveSender == null) {
            ...
            attempts        = 0;
            connected       = true;
            keepAliveSender = new id.co.projectscoid.push.WebSocketConnection.KeepAliveSender();
