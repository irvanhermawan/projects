package id.co.projectscoid.components.camera;
...
import id.co.projectscoid.components.KeyboardAwareLinearLayout;
import id.co.projectscoid.components.camera.CameraView.CameraViewListener;
