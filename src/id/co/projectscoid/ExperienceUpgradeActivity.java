...
import id.co.projectscoid.IntroPagerAdapter.IntroPage;
...
public class ExperienceUpgradeActivity extends BaseActionBarActivity {
  ...
  private static final String DISMISS_ACTION  = "id.co.projectscoid.ExperienceUpgradeActivity.DISMISS_ACTION";
