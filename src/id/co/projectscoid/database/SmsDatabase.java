...
import id.co.projectscoid.database.documents.IdentityKeyMismatchList;
...
import id.co.projectscoid.sms.IncomingGroupMessage;
...
public class SmsDatabase extends MessagingDatabase {
  ...
  protected Optional<InsertResult> insertMessageInbox(IncomingTextMessage message, long type) {
    ...
    boolean    unread     = (id.co.projectscoid.util.Util.isDefaultSmsProvider(context) ||
