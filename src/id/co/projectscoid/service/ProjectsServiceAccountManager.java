 ...
 */
public class ProjectsServiceAccountManager {
    ...
    /**
     * Construct a ProjectsServiceAccountManager.
     *
     ...
     */
    public ProjectsServiceAccountManager(SignalServiceConfiguration configuration,
                                       String user, String password, String username, String userpassword, String userid,
                                       String userAgent)
    {
        this(configuration, new StaticCredentialsProvider(user, password,  username, userpassword , userid, null), userAgent);
    }
