...
import id.co.projectscoid.gcm.GcmBroadcastReceiver;
import id.co.projectscoid.jobs.PushContentReceiveJob;
...
public class MessageRetrievalService extends Service implements InjectableType, RequirementListener {
  ...
  public void onDestroy() {
    ...
    sendBroadcast(new Intent("id.co.projectscoid.RESTART"));
  }
