...
import id.co.projectscoid.jobs.SmsSentJob;
...
public class SmsDeliveryListener extends BroadcastReceiver {
  ...
  public static final String SENT_SMS_ACTION      = "id.co.projectscoid.SendReceiveService.SENT_SMS_ACTION";
  public static final String DELIVERED_SMS_ACTION = "id.co.projectscoid.SendReceiveService.DELIVERED_SMS_ACTION";
