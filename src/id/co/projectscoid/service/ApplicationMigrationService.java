    ...
    implements SmsMigrator.SmsMigrationProgressListener
{
  ...
  public  static final String MIGRATE_DATABASE  = "id.co.projectscoid.ApplicationMigration.MIGRATE_DATABSE";
  public  static final String COMPLETED_ACTION  = "id.co.projectscoid.ApplicationMigrationService.COMPLETED";
