...
public class KeyCachingService extends Service {
  ...
  public  static final String KEY_PERMISSION           = "id.co.projectscoid.ACCESS_SECRETS";
  public  static final String NEW_KEY_EVENT            = "id.co.projectscoid.service.action.NEW_KEY_EVENT";
  public  static final String CLEAR_KEY_EVENT          = "id.co.projectscoid.service.action.CLEAR_KEY_EVENT";
  private static final String PASSPHRASE_EXPIRED_EVENT = "id.co.projectscoid.service.action.PASSPHRASE_EXPIRED_EVENT";
  public  static final String CLEAR_KEY_ACTION         = "id.co.projectscoid.service.action.CLEAR_KEY";
  public  static final String DISABLE_ACTION           = "id.co.projectscoid.service.action.DISABLE";
  public  static final String ACTIVITY_START_EVENT     = "id.co.projectscoid.service.action.ACTIVITY_START_EVENT";
  public  static final String ACTIVITY_STOP_EVENT      = "id.co.projectscoid.service.action.ACTIVITY_STOP_EVENT";
  public  static final String LOCALE_CHANGE_EVENT      = "id.co.projectscoid.service.action.LOCALE_CHANGE_EVENT";
