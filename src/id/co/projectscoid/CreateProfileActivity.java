...
import id.co.projectscoid.components.emoji.EmojiToggle;
...
import id.co.projectscoid.profiles.AvatarHelper;
import id.co.projectscoid.profiles.ProfileMediaConstraints;
import id.co.projectscoid.profiles.SystemProfileUtil;
import id.co.projectscoid.util.BitmapDecodingException;
...
import id.co.projectscoid.util.FileProviderUtil;
import id.co.projectscoid.util.IntentUtils;
...
public class CreateProfileActivity extends BaseActionBarActivity implements InjectableType {
  ...
  private Intent createAvatarSelectionIntent(@Nullable File captureFile, boolean includeClear, boolean includeCamera) {
    ...
    if (includeClear) {
      extraIntents.add(new Intent("id.co.projectscoid.action.CLEAR_PROFILE_PHOTO"));
    }
