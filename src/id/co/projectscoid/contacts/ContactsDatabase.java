...
public class ContactsDatabase {
  ...
  private static final String CONTACT_MIMETYPE = "vnd.android.cursor.item/vnd.id.co.projectscoid.contact";
  private static final String CALL_MIMETYPE    = "vnd.android.cursor.item/vnd.id.co.projectscoid.call";
