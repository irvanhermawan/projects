...
import id.co.projectscoid.animation.AnimationCompleteListener;
import id.co.projectscoid.backup.FullBackupBase;
import id.co.projectscoid.backup.FullBackupImporter;
import id.co.projectscoid.components.registration.CallMeCountDownView;
import id.co.projectscoid.components.registration.VerificationCodeView;
import id.co.projectscoid.components.registration.VerificationPinKeyboard;
...
import id.co.projectscoid.database.NoExternalStorageException;
import id.co.projectscoid.jobs.DirectoryRefreshJob;
...
import id.co.projectscoid.util.PlayServicesUtil;
import id.co.projectscoid.util.PlayServicesUtil.PlayServicesStatus;
...
public class RegistrationActivity extends BaseActionBarActivity implements VerificationCodeView.OnCodeEnteredListener {
  ...
  public static final  String CHALLENGE_EVENT           = "id.co.projectscoid.CHALLENGE_EVENT";
